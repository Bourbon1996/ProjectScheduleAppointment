...
<nav class="navbar navbar-expand-lg hospital-navbar p-0">

    <div class="container-fluid">

        <!-- Logo -->
        <a class="navbar-brand hospital-brand"
           href="${ctx}/home/index">
        ...
        <!-- Nút menu ☰ cho tablet/mobile -->
        <button class="navbar-toggler hospital-navbar-toggler"
                type="button"
                data-bs-toggle="collapse"
                data-bs-target="#hospitalNavbarMenu"
                aria-controls="hospitalNavbarMenu"
                aria-expanded="false"
                aria-label="Mở menu">
        ...
        <!-- Khu vực menu có thể thu gọn -->
        <div class="collapse navbar-collapse"
             id="hospitalNavbarMenu">
            ...
            <ul class="navbar-nav w-100 align-items-stretch">
                        ...
                        <div class="mega-menu-content d-flex">
                                                ...
                                                <div class="child-column shadow-sm">
                                                    ...
                                                    <div class="child-scroll-box">
                                                        ...
                                                        <ul class="child-list list-unstyled mb-0">
                                                            ...
                                                            <c:forEach items="${parent.subDepartments}"
                                                                       var="child">
                            ...
                            <div class="child-column-placeholder">
                                ...
                                <div class="text-muted small p-4">
                                    Di chuột vào khoa bên trái để xem danh sách chi tiết
                                </div>
                    ...
                    <div class="dropdown-menu mega-menu p-0">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-8 mega-menu-intro">
                                ...
                                <p>
                                    Bệnh viện Đại học Y Dược TP. Hồ Chí Minh là bệnh viện
                                    công lập hạng I, đa khoa chuyên sâu kỹ thuật cao,
                                    trực thuộc Đại học Y Dược TP. Hồ Chí Minh có chất lượng
                                    hàng đầu cả nước. Sự kết hợp hài hòa giữa người Thầy giáo -
                                    Thầy thuốc và Nhà khoa học, sự gắn kết Trường - Viện đã tạo
                                    nên thế mạnh của Bệnh viện.
                                </p>

                                <p>
                                    Những trụ cột quan trọng: Điều trị chuyên sâu - Đào tạo
                                    chuẩn mực - Nghiên cứu đột phá - Quản trị hiện đại tạo nền
                                    móng vững chắc để Bệnh viện khẳng định vị thế trên bản đồ
                ...
                <li class="nav-item ms-lg-auto">
                    ...
                    <a class="nav-link appointment-link"
                       href="${ctx}/appointment">
